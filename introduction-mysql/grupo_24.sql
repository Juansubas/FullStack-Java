...
CREATE TABLE IF NOT EXISTS `grupo_24`.`telefono` (
  ...
  `decano_cedula` VARCHAR(15) NULL,
  `telefonocol` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `grupo_24`.`titulo` (
  `id` INT NOT NULL,
  `titulocol` VARCHAR(120) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `grupo_24`.`docente_titulo` (
  ...
  INDEX `fk_titulo_has_docente_docente1_idx` (`docente_cedula` ASC) VISIBLE,
  INDEX `fk_titulo_has_docente_titulo1_idx` (`titulo_id` ASC) VISIBLE,
  CONSTRAINT `fk_titulo_has_docente_titulo1`
    FOREIGN KEY (`titulo_id`)
    REFERENCES `grupo_24`.`titulo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_titulo_has_docente_docente1`
...
-- -----------------------------------------------------
-- Table `grupo_24`.`estudiante_has_asignatura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `grupo_24`.`estudiante_has_asignatura` (
  ...
  INDEX `fk_estudiante_has_asignatura_asignatura1_idx` (`asignatura_codigo` ASC) VISIBLE,
  INDEX `fk_estudiante_has_asignatura_estudiante1_idx` (`estudiante_tarjeta_identidad` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `grupo_24`.`docente_asignatura` (
  ...
  `asignatura_codigo` VARCHAR(10) NOT NULL,
  `docente_cedula` VARCHAR(15) NOT NULL,
  `docente_cedula1` VARCHAR(15) NOT NULL,
  `asignatura_codigo1` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_docente_asignatura_docente1_idx` (`docente_cedula1` ASC) VISIBLE,
  INDEX `fk_docente_asignatura_asignatura1_idx` (`asignatura_codigo1` ASC) VISIBLE,
  CONSTRAINT `fk_docente_asignatura_docente1`
    FOREIGN KEY (`docente_cedula1`)
    REFERENCES `grupo_24`.`docente` (`cedula`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_docente_asignatura_asignatura1`
    FOREIGN KEY (`asignatura_codigo1`)
    REFERENCES `grupo_24`.`asignatura` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
