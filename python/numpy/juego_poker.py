...
def crear_baraja(valor_cartas):
    # el _ permite que la variable ahí sea interna y no vaya a exitir conflictos
    ...
    #Une las listas como una sola [1, 2] + [3, 4] -> [1, 2, 3, 4]
...
def poner_en_mesa(cartas: list):
    #sacar cartas
    #el pop saca el último elemento de la baraja o sea de lista de cartas
    carta_1 = cartas.pop()
    carta_2 = cartas.pop()
    carta_3 = cartas.pop()
